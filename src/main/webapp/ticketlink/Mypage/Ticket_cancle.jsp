                ...
                <div class="help_cont"> 
                    ...
                    <div class="help_recont"> 
                        ...
                        <div class="paging"> <!--페이지 이동-->
                            ...
                            %>
                            <a href="/Tcp2/Controller?command=ticket_checkR?currP=1" class="first">맨앞</a>
                            <a href="/Tcp2/Controller?command=ticket_checkR?currP=<%=Math.max(currP -1, 1)%>" class="prev">이전</a>
                            <strong><%=currP%></strong>
                            <a href="/Tcp2/Controller?command=ticket_checkR?currP=<%=Math.min(currP + 1, count)%>" class="next">다음</a>
                            <a href="/Tcp2/Controller?command=ticket_checkR?currP=<%=count%>" class="end">맨뒤</a>
                        </div>
                        <div class="note">
                            <h6>
                                <span></span>
