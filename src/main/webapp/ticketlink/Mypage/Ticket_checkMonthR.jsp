                ...
                <div class="help_cont"> 
                    ...
                    <div class="help_recont"> 
                        ...
                        <ul class="mypage_tab"> <!--예매확인 / 예매취소-->
                            	...
                            	<li class="on"><a href	="/Tcp2/Controller?command=ticket_checkR">예매취소</a></li>
                        </ul>
                        <div class="sortbox">
                            <dl class="daytbox fl">
                                <dt>기간별 조회</dt>
                        ...
                        <div class="paging"> <!--페이지 이동-->
                           <%
                            ...
                            %>
                            <a href="/Tcp2/Ticket_checkMonthRServlet?viOrRe=<%=viOrRe %>&year=<%=year%>&month=<%=month%>&currP=1" class="first">맨앞</a>
                            <a href="/Tcp2/Ticket_checkMonthRServlet?viOrRe=<%=viOrRe %>&year=<%=year%>&month=<%=month%>&currP=<%=Math.max(currP -1, 1)%>" class="prev">이전</a>
                            <strong><%=currP%></strong>
                            <a href="/Tcp2/Ticket_checkMonthRServlet?viOrRe=<%=viOrRe %>&year=<%=year%>&month=<%=month%>&currP=<%=Math.min(currP + 1, count)%>" class="next">다음</a>
                            <a href="/Tcp2/Ticket_checkMonthRServlet?viOrRe=<%=viOrRe %>&year=<%=year%>&month=<%=month%>&currP=<%=count%>" class="end">맨뒤</a>
                        </div>
                        <div class="note">
                            <h6>
                                <span></span>
