                    ...
                    <div class="help_recont"> 
                            ...
                            <dl class="daytbox fl">
                                ...
                                <dd style="float: left"> <!--기간별 조회-->
                                    <ul class="daysort">
                                        ...
                                        <li><a href="/Tcp2/Controller?command=ticket_check_period&day=60" class="search">2개월</a></li>
                        ...
                        <div class="paging"> <!--페이지 이동-->
                           <%
                            ...
                            %>
                            <a href="/Tcp2/Controller?command=ticket_check_period&day=60&currP=1" class="first">맨앞</a>
                            <a href="/Tcp2/Controller?command=ticket_check_period&day=60&currP=<%=Math.max(currP -1, 1)%>" class="prev">이전</a>
                            <strong><%=currP%></strong>      
                            <a href="/Tcp2/Controller?command=ticket_check_period&day=60&currP=<%=Math.min(currP + 1, count)%>" class="next">다음</a>
                            <a href="/Tcp2/Controller?command=ticket_check_period&day=60&currP=<%=count%>" class="end">맨뒤</a>
                        </div>
                        <div class="note">
                            <h6>
                                <span></span>
