...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Tcp2/assets/css/find_id.css">
</head>
<body>
    <!--홈페이지상단-->
                        ...
                        <div class="cotent_wrap">
                            <div class="content_inner">
                                ...
                                <form action="/Tcp2/Find_idResultServlet" method="post" id="toResultservlet">
                                    ...
                                    <div class="input_style">
                                        <input type="text" id="input_memberPh" name="phone" class="search_input" placeholder="휴대폰 번호 (-없이 입력)">
                                        <span class="del_btn"></span>
                                    </div>
                                </form>
                                    ...
                                    <div class="error_message nomember" style="display: none;">입력하신 정보와 일치하는 회원이 없습니다. 다른 인증수단으로 재시도해주세요.</div>
