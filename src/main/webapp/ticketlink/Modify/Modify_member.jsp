    ...
    <div class="common_header"> <!--홈페이지상단-->
        <div class="header_inner">
            <div class="inner">
                ...
                <ul class="my_menu">
                    <li>
                        <a href="#" onclick="if(confirm('로그아웃 하시겠습니까?')) { window.location.href='/Tcp2/Controller?command=logout'; } return false;">로그아웃</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="content_wrap">
            <div class="left_menu_area">
                ...
                <div class="my_menu_area"> <!--왼쪽 메뉴들-->
                    <ul>
                        <li class="modify current"><a href="/Tcp2/Controller?command=modify_member">회원정보수정</a></li>
