...
public class MeetIntroduceWriteDTO {
	private String meet_name;
	private String url;
	private int meet_member_count;
	
	public MeetIntroduceWriteDTO(String meet_name, String url, int meet_member_count) {
	...
	public String toString() {
		return "MeetIntroduceWriteDTO [meet_name=" + meet_name + ", url=" + url + ", meet_member_count="
				+ meet_member_count + "]";
	}
